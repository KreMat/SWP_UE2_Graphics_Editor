 ...
 * 
 */
public class Ellipse extends AbstractGraphicalElement implements Colored,
		HasThickness {
	...
	public void draw(IRenderer r) {
		if (filled) {
			r.drawFilledEllipse(x, y, width, height, thickness, color);
		} else {
			r.drawEllipse(x, y, width, height, thickness, color);
		}
	}
